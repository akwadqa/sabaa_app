...
// class _UnifiedInvoiceReviewPageState
//     extends ConsumerState<UnifiedInvoiceReviewPage> {
//   final deliveryFeeFocus = FocusNode();
//   final remarkFocus = FocusNode();

//   @override
//   void dispose() {
//     deliveryFeeFocus.dispose();
//     remarkFocus.dispose();
//     super.dispose();
//   }
...
//         InvoiceReviewMode.newOrder => _NewOrderBody(),
//         InvoiceReviewMode.returnOrder => _ReturnOrderBody(),
//         InvoiceReviewMode.viewOnly => _ViewOnlyBody(),
//       },
//     );
//   }
...
//           debugPrint(
//               '🖨 Converting HTML with format: ${format.width}x${format.height}');
...
// class _NewOrderBody extends ConsumerStatefulWidget {
//   @override
//   ConsumerState<_NewOrderBody> createState() => _NewOrderBodyState();
// }

// class _NewOrderBodyState extends ConsumerState<_NewOrderBody> {
//   // 👇 1. Declare FocusNode
//   final FocusNode _deliveryFeeFocusNode = FocusNode();

//   @override
//   void dispose() {
//     _deliveryFeeFocusNode.dispose(); // 👇 2. Always dispose
//     super.dispose();
//   }
...
//                 focusNode: _deliveryFeeFocusNode, // 👈 key line
...
//                           salesMan: SizedBox(),
//                           // vanSales: SizedBox(),
//                           defaultWidget: CustomButtonWidget(
//                             text: "pay_now",
//                             onTap: () {
