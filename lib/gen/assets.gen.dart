...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/ic_settings_locale.svg
  SvgGenImage get icSettingsLocale =>
      const SvgGenImage('assets/icons/ic_settings_locale.svg');

  /// File path: assets/icons/ic_settings_logout.svg
  SvgGenImage get icSettingsLogout =>
      const SvgGenImage('assets/icons/ic_settings_logout.svg');

  /// File path: assets/icons/ic_settings_my_account.svg
  SvgGenImage get icSettingsMyAccount =>
      const SvgGenImage('assets/icons/ic_settings_my_account.svg');

  /// File path: assets/icons/ic_settings_theme_mode.svg
