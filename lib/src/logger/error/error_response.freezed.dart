...
abstract mixin class $ErrorResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String message, dynamic status, dynamic data});
}
...
extension ErrorResponsePatterns on ErrorResponse {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String message, dynamic status, dynamic data)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ErrorResponse() when $default != null:
        return $default(_that.message, _that.status, _that.data);
      case _:
        return orElse();
    }
  }
